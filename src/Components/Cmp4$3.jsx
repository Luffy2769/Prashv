  ...
  return (
    <div
      ...
      style={{
        ...
        background:
          "linear-gradient(to left, #181818 0%, rgba(0,255,255,0.15) 100%)", // gradient for the whole page that comes under this div
      }}
    >
      ...
      <span
        ...
        style={{
          position: "relative",
          background:
            "radial-gradient(circle, rgba(0,255,255,0.3) 30%, transparent 70%)", // Weird color (maybe cyan) gradient
          borderRadius: "50%",
      ...
      <span className="text-white text-2xl ml-12 my-24 leading-none inline-block">
        your vision, bought to life with masterful artistry.
      </span>
    </div>
  );
}
